...
public interface AnalysisDAO {
	//전체 기업 정보 조회하기
	ArrayList<EnterpriseDTO> select_ent1(Connection con, String encode) throws SQLException;
	
	ArrayList<EnterpriseinfoDTO> select_ent(Connection con, String encode) throws SQLException;
