             ...
             <tr>
                 ...
                 <td>
                     <ul>
                         ...
                         <li><input type="checkbox" class="chk1" name="ForgnSectCd" id="fund1-2" value="1"> <label for="fund1-2">국내</label></li>
                         <li><input type="checkbox"  class="chk1" name="ForgnSectCd" id="fund1-3" value="2" > <label for="fund1-3">해외</label></li>
                     </ul>
                 </td>
...
<colgroup>
    ...
    <thead class="sort">
        <tr>
            ...
            <th scope="colgroup" colspan="5">수익률(%)</th> -->
